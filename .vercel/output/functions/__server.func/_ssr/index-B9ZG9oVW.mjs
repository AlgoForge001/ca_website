...
function HomePage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative overflow-hidden bg-brand-black text-white", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "aria-hidden": true, className: "absolute inset-0 opacity-[0.07]", style: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container-pg relative py-20 md:py-32", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 rounded-sm border border-white/15 px-3 py-1.5 text-xs font-semibold uppercase tracking-[0.18em] text-brand-red", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "h-1.5 w-1.5 rounded-full bg-brand-red" }),
          "Trusted Since 2001"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "mt-6 font-display text-4xl md:text-6xl font-extrabold leading-[1.05] text-white", children: [
          "Expert Tax & GST",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 flex flex-col sm:flex-row gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "tel:+919822979157", className: "inline-flex items-center justify-center gap-2 rounded-sm bg-brand-red px-7 py-3.5 text-sm font-semibold text-white hover:bg-brand-red-dark transition-colors", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "h-4 w-4" }),
            " Call Now"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "https://wa.me/919822979157", target: "_blank", rel: "noopener noreferrer", className: "inline-flex items-center justify-center gap-2 rounded-sm border border-white/20 bg-white/5 px-7 py-3.5 text-sm font-semibold text-white hover:bg-white/10 transition-colors", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(MessageCircle, { className: "h-4 w-4" }),
            " WhatsApp Us"
          ] })
        ] })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative border-t border-white/10 bg-black/30", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container-pg grid grid-cols-2 md:grid-cols-4 divide-x divide-white/10", children: [{
        v: "25+",
        l: "Years Experience"
      }, {
        v: "5000+",
        ...
        v: "100%",
        l: "Compliance"
      }].map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-6 py-8 text-center", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "section-pg bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-pg", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-6 md:grid-cols-2 lg:grid-cols-3", children: services.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card-service group", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-12 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/services", className: "inline-flex items-center gap-2 text-sm font-semibold text-brand-red hover:gap-3 transition-all", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "section-pg bg-muted", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-pg", children: [
      ...
      }].map((f) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card p-7 rounded-sm border border-border", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "section-pg bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-pg grid lg:grid-cols-2 gap-12 items-start", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/documents", className: "inline-flex items-center gap-2 text-sm font-semibold text-brand-red hover:gap-3 transition-all", children: [
          "View Full Checklist ",
          /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { className: "h-4 w-4" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-card border border-border border-l-[3px] border-l-brand-red rounded-sm p-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "grid sm:grid-cols-2 gap-3", children: itrDocuments.map((d, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-3 text-sm", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "section-pg bg-muted", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-pg", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-6 sm:grid-cols-2 lg:grid-cols-5", children: team.map((m) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border-t-[3px] border-brand-red rounded-sm p-6 text-center hover:-translate-y-1 transition-transform", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "section-pg bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-pg", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-6 md:grid-cols-3", children: testimonials.slice(0, 3).map((t) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border p-7 rounded-sm", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-brand-red text-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-pg py-16 md:py-20 flex flex-col md:flex-row items-center justify-between gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "https://wa.me/919822979157", target: "_blank", rel: "noopener noreferrer", className: "inline-flex items-center gap-2 rounded-sm bg-white px-6 py-3.5 text-sm font-semibold text-brand-red hover:bg-white/90 transition-colors", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(MessageCircle, { className: "h-4 w-4" }),
          " WhatsApp Us"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "tel:+919822979157", className: "inline-flex items-center gap-2 rounded-sm border border-white/40 px-6 py-3.5 text-sm font-semibold text-white hover:bg-white/10 transition-colors", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "h-4 w-4" }),
          " Call"
        ] })
      ] })
